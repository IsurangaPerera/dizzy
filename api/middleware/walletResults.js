...
const walletResults = asyncHandler(async (request, response, next) => {
  ...
  response.walletResults = {
    ...
    data: [
      {
        id: '6ca4a6605be5da279a94cb735c462e1d8da736d023bdcddf1880e8720dccabd4',
        name: 'BitcoinVideosCasino.com',
        clusteredAt: '2020-10-27T22:37:24.256+00:00',
        volume: '3245',
        size: '1270',
        info: [
          { title: 'Safety', text: 'N/A' },
          { title: 'Category', text: 'N/A' },
          { title: 'Dizzy Rank', text: 'N/A' },
        ],
      },
      {
        id: '8ca4a6605be5da279a94cb735c462e1d8da736d023bdcddf1880e8720dccabd4',
        name: 'SatoshiDice.com',
        clusteredAt: '2020-10-27T22:37:24.256+00:00',
        volume: '242342',
        size: '3232',
        info: [
      ...
      data: [
        {
          ...
          size: '561270',
          info: [
            { title: 'Safety', text: 'Malicious' },
            { title: 'Category', text: 'Ransomware' },
            { title: 'Dizzy Rank', text: '0.95' },
          ],
        },
        {
          id: '3ab4a6605be5da279a94cb735c876e6d8da736d023bdcddf1880e8720dccabd5',
          name: 'AlphaBayMarket',
          clusteredAt: '2020-10-27T22:37:24.256+00:00',
          volume: '478335',
          size: '98970',
          info: [
            ...
            { title: 'Category', text: 'Marketplace' },
            { title: 'Dizzy Rank', text: '0.80' },
          ],
        },
        {
          id: '8bb4a6605be5da976b94cb735c462e1d8da736d023bdcddf1880e8720dccabd5',
          name: 'GreenRoadMarket',
          clusteredAt: '2020-10-27T22:37:24.256+00:00',
          volume: '8946783',
          size: '432686',
          info: [
        ...
        {
          id: '5ab766605be5da279a94cb735c462e1d8da736d023bdcddf1880e8720dccaaa7',
          name: 'BitLaunder.com',
          clusteredAt: '2020-10-27T22:37:24.256+00:00',
          volume: '324324',
          size: '634323',
          info: [
            { title: 'Safety', text: 'Benign' },
            { title: 'Category', text: 'Mixing Service' },
            { title: 'Dizzy Rank', text: '0.64' },
          ],
        },
      ],
    };
